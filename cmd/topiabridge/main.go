...
import (
	...
	"github.com/fabbez/topiastratum/src/topiastratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	flag.StringVar(&cfg.RPCServer, "topia", cfg.RPCServer, "address of the topiad node, default `localhost:18110`")
	...
	if err := topiastratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
